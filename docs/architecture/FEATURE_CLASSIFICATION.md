...
# Feature Classification — NirvaMedia

| Feature/capability | Current status | Disposition |
|---|---|---|
| Campaign/product studio | implemented | KEEP; wrap with canonical boundaries |
| Translation memory | implemented | KEEP; wrap with canonical boundaries |
| Live publishing | partial | EVALUATE; complete only in canonical owner |
| AI media source | partial | EVALUATE; complete only in canonical owner |
